  ...
  def create
    ...
    if params[:invitation][:invite_type] == "bookshelf"
      if ! @user_invited.blank? and has_bookshelfrelation?(bookshelf_id, @user_invited.id)
        ...
        Mailer.invitation_bookshelf(@invitation_resent, current_user, root_url + "bookshelf/" + @invitation_resent.token, msg).deliver
        redirect_to root_url, :notice => "Your invitation has been re-sent to " + @invitation_resent.recipient_email
      elsif @invitation.save
        Mailer.invitation_bookshelf(@invitation, current_user, root_url + "bookshelf/" + @invitation.token, msg).deliver
